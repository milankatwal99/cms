            ...
            <div class="row">
                        ...
                        @foreach($post as $posts)
                            ...
                            <div class="col-md-6">
                                <div class="card border hover-shadow-6 mb-6 d-block">
                                    <a href="#"><img class="card-img-top" src="{{ asset('image/website.jpeg') }}" alt="Card image cap"></a>
                                    <div class="p-6 text-center">
                                        <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="#">{{ $posts->category->name }}</a></p>
                ...
                <div class="col-md-4 col-xl-3">
                    <div class="sidebar px-4 py-md-0">
                        ...
                        <form action = "{{ route('welcome') }}"class="input-group" target="#" method="GET">
                        ...
                        <div class="row link-color-default fs-14 lh-24">
                            @foreach($category as $categorys)
                                <div class="col-6"><a href="#">{{$categorys->name}}</a></div>
                            @endforeach
                        </div>
                        ...
                        <div class="gap-multiline-items-1">
                            @foreach($tag as $tags)
                                <a class="badge badge-secondary" href="#">{{ $tags->name }}</a>
                            @endforeach
                        </div>
